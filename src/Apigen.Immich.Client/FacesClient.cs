...
public partial class FacesClient
{
  ...
  internal FacesClient(HttpClient httpClient, ILogger? logger = null)
  {
  ...
  /// Operation: GET /faces
  /// </summary>
  public async Task<List<AssetFaceResponseDto>> GetFacesAsync(GetFacesRequest? request = null, CancellationToken cancellationToken = default)
  {
    string url = "faces".BuildUrl(request: request);
    ...
    try
    {
      ...
      List<AssetFaceResponseDto>? result = JsonSerializer.Deserialize<List<AssetFaceResponseDto>>(responseContent, JsonConfig.Default);
      return result ?? new List<AssetFaceResponseDto>();
    }
  ...
  /// </summary>
  public async Task CreateAsync(Apigen.Immich.Models.AssetFaceCreateDto assetFaceCreateDto, CancellationToken cancellationToken = default)
  {
    string url = "faces";
    ...
    try
    {
      ...
      string json = JsonSerializer.Serialize(assetFaceCreateDto, JsonConfig.Default);
  ...
  /// </summary>
  public async Task DeleteAsync(string id, Apigen.Immich.Models.AssetFaceDeleteDto assetFaceDeleteDto, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
    };
    string url = "faces/{id}".BuildUrl(pathParams);
  ...
  /// </summary>
  public async Task<PersonResponseDto> UpdateAsync(string id, Apigen.Immich.Models.FaceDto faceDto, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
    ...
    try
    {
      ...
      string json = JsonSerializer.Serialize(faceDto, JsonConfig.Default);
