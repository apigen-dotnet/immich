...
public partial class ViewsClient
{
  ...
  /// </summary>
  public async Task<List<AssetResponseDto>> GetAssetsByOriginalPathAsync(GetAssetsByOriginalPathRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<JsonElement> GetUniqueOriginalPathsAsync(CancellationToken cancellationToken = default)
  {
