...
public class AssetsClient
{
  ...
  public async Task<AssetMediaResponseDto> UploadAssetAsync(Apigen.Immich.Models.AssetMediaCreateDto assetMediaCreateDto, UploadAssetRequest? request = null)
  {
    ...
    string json = JsonSerializer.Serialize(assetMediaCreateDto, JsonConfig.Default);
  ...
  /// </summary>
  public async Task<object> DownloadAssetAsync(string id, DownloadAssetRequest? request = null)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  public async Task<AssetMediaResponseDto> ReplaceAssetAsync(string id, Apigen.Immich.Models.AssetMediaReplaceDto assetMediaReplaceDto, ReplaceAssetRequest? request = null)
  {
    ...
    long startTimestamp = System.Diagnostics.Stopwatch.GetTimestamp();
    HttpClientLog.RequestStarted(_logger, "PUT", url);
    string json = JsonSerializer.Serialize(assetMediaReplaceDto, JsonConfig.Default);
    HttpClientLog.RequestBody(_logger, "PUT", json);
    StringContent content = new StringContent(json, Encoding.UTF8, "application/json");
    HttpResponseMessage response = await _httpClient.PutAsync(url, content);
    long durationMs = (long)System.Diagnostics.Stopwatch.GetElapsedTime(startTimestamp).TotalMilliseconds;
  ...
  /// </summary>
  public async Task<object> ViewAssetAsync(string id, ViewAssetRequest? request = null)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<object> PlayAssetVideoAsync(string id, PlayAssetVideoRequest? request = null)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
