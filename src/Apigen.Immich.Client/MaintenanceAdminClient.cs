...
public partial class MaintenanceAdminClient
{
  ...
  /// </summary>
  public async Task SetMaintenanceModeAsync(Apigen.Immich.Models.SetMaintenanceModeDto setMaintenanceModeDto, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<MaintenanceDetectInstallResponseDto> DetectPriorInstallAsync(CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<MaintenanceAuthDto> MaintenanceLoginAsync(Apigen.Immich.Models.MaintenanceLoginDto maintenanceLoginDto, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<MaintenanceStatusResponseDto> GetMaintenanceStatusAsync(CancellationToken cancellationToken = default)
  {
