...
public class StacksClient
{
  ...
  /// </summary>
  public async Task DeleteStacksAsync(Apigen.Immich.Models.BulkIdsDto bulkIdsDto)
  {
    string url = "stacks";
  ...
  /// </summary>
  public async Task<List<StackResponseDto>> SearchStacksAsync(SearchStacksRequest? request = null)
  {
  ...
  /// </summary>
  public async Task<StackResponseDto> CreateAsync(Apigen.Immich.Models.StackCreateDto stackCreateDto)
  {
    string url = "stacks";
  ...
  /// </summary>
  public async Task<StackResponseDto> GetAsync(string id)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<StackResponseDto> UpdateAsync(string id, Apigen.Immich.Models.StackUpdateDto stackUpdateDto)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task DeleteAsync(string assetId, string id)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["assetId"] = assetId,
