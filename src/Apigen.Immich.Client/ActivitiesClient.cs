...
public partial class ActivitiesClient
{
  ...
  /// </summary>
  public async Task<List<ActivityResponseDto>> GetActivitiesAsync(GetActivitiesRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ActivityResponseDto> CreateActivityAsync(Apigen.Immich.Models.ActivityCreateDto activityCreateDto, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ActivityStatisticsResponseDto> GetActivityStatisticsAsync(GetActivityStatisticsRequest? request = null, CancellationToken cancellationToken = default)
  {
