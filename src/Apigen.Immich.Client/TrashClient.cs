...
public partial class TrashClient
{
  ...
  /// </summary>
  public async Task<TrashResponseDto> EmptyTrashAsync(CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<TrashResponseDto> RestoreTrashAsync(CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<TrashResponseDto> RestoreAssetsAsync(Apigen.Immich.Models.BulkIdsDto bulkIdsDto, CancellationToken cancellationToken = default)
  {
