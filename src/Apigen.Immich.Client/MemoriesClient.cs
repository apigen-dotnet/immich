...
public partial class MemoriesClient
{
  ...
  /// </summary>
  public async Task<List<MemoryResponseDto>> SearchMemoriesAsync(SearchMemoriesRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<MemoryResponseDto> CreateMemoryAsync(Apigen.Immich.Models.MemoryCreateDto memoryCreateDto, CancellationToken cancellationToken = default)
  {
    string url = "memories";
  ...
  /// </summary>
  public async Task<MemoryStatisticsResponseDto> MemoriesStatisticsAsync(MemoriesStatisticsRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<MemoryResponseDto> GetAsync(string id, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<MemoryResponseDto> UpdateAsync(string id, Apigen.Immich.Models.MemoryUpdateDto memoryUpdateDto, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<List<BulkIdResponseDto>> RemoveMemoryAssetsAsync(string id, Apigen.Immich.Models.BulkIdsDto bulkIdsDto, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<List<BulkIdResponseDto>> AddMemoryAssetsAsync(string id, Apigen.Immich.Models.BulkIdsDto bulkIdsDto, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
