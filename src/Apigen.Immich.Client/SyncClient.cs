...
public partial class SyncClient
{
  ...
  /// </summary>
  public async Task DeleteSyncAckAsync(Apigen.Immich.Models.SyncAckDeleteDto syncAckDeleteDto, CancellationToken cancellationToken = default)
  {
    string url = "sync/ack";
    ...
    try
    {
      ...
      string json = JsonSerializer.Serialize(syncAckDeleteDto, JsonConfig.Default);
  ...
  /// </summary>
  public async Task<List<SyncAckDto>> GetSyncAckAsync(CancellationToken cancellationToken = default)
  {
    string url = "sync/ack";
  ...
  /// </summary>
  public async Task SendSyncAckAsync(Apigen.Immich.Models.SyncAckSetDto syncAckSetDto, CancellationToken cancellationToken = default)
  {
    string url = "sync/ack";
  ...
  /// </summary>
  public async Task<AssetDeltaSyncResponseDto> GetDeltaSyncAsync(Apigen.Immich.Models.AssetDeltaSyncDto assetDeltaSyncDto, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<List<AssetResponseDto>> GetFullSyncForUserAsync(Apigen.Immich.Models.AssetFullSyncDto assetFullSyncDto, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task GetSyncStreamAsync(Apigen.Immich.Models.SyncStreamDto syncStreamDto, CancellationToken cancellationToken = default)
  {
