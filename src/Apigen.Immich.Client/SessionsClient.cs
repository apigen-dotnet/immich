...
public partial class SessionsClient
{
  ...
  /// </summary>
  public async Task<List<SessionResponseDto>> GetSessionsAsync(CancellationToken cancellationToken = default)
  {
    string url = "sessions";
  ...
  /// </summary>
  public async Task<SessionCreateResponseDto> CreateAsync(Apigen.Immich.Models.SessionCreateDto sessionCreateDto, CancellationToken cancellationToken = default)
  {
    string url = "sessions";
  ...
  /// </summary>
  public async Task<SessionResponseDto> UpdateAsync(string id, Apigen.Immich.Models.SessionUpdateDto sessionUpdateDto, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task LockSessionAsync(string id, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
