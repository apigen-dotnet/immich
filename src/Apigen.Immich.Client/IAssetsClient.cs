...
public interface IAssetsClient
{
  ...
  /// </summary>
  Task<Stream> DownloadAssetAsync(string id, DownloadAssetRequest? request = null);
  ...
  /// </summary>
  Task<Stream> ViewAssetAsync(string id, ViewAssetRequest? request = null);

  /// <summary>
  /// Play asset video
  /// Operation: GET /assets/{id}/video/playback
  /// </summary>
  Task<Stream> PlayAssetVideoAsync(string id, PlayAssetVideoRequest? request = null);
