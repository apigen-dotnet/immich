...
public partial class SystemMetadataClient
{
  ...
  /// </summary>
  public async Task<AdminOnboardingUpdateDto> GetAdminOnboardingAsync(CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task UpdateAdminOnboardingAsync(Apigen.Immich.Models.AdminOnboardingUpdateDto adminOnboardingUpdateDto, CancellationToken cancellationToken = default)
  {
    string url = "system-metadata/admin-onboarding";
  ...
  /// </summary>
  public async Task<ReverseGeocodingStateResponseDto> GetReverseGeocodingStateAsync(CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<VersionCheckStateResponseDto> GetVersionCheckStateAsync(CancellationToken cancellationToken = default)
  {
