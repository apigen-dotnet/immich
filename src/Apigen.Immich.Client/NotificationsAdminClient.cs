...
public partial class NotificationsAdminClient
{
  ...
  /// </summary>
  public async Task<NotificationDto> CreateNotificationAsync(Apigen.Immich.Models.NotificationCreateDto notificationCreateDto, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<TemplateResponseDto> GetNotificationTemplateAdminAsync(string name, Apigen.Immich.Models.TemplateDto templateDto, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<TestEmailResponseDto> SendTestEmailAdminAsync(Apigen.Immich.Models.SystemConfigSmtpDto systemConfigSmtpDto, CancellationToken cancellationToken = default)
  {
