...
public partial class DuplicatesClient
{
  ...
  internal DuplicatesClient(HttpClient httpClient, ILogger? logger = null)
  {
  ...
  /// </summary>
  public async Task DeleteDuplicatesAsync(Apigen.Immich.Models.BulkIdsDto bulkIdsDto, CancellationToken cancellationToken = default)
  {
    string url = "duplicates";
  ...
  /// </summary>
  public async Task<List<DuplicateResponseDto>> GetAssetDuplicatesAsync(CancellationToken cancellationToken = default)
  {
    string url = "duplicates";
    ...
    try
    {
      ...
      List<DuplicateResponseDto>? result = JsonSerializer.Deserialize<List<DuplicateResponseDto>>(responseContent, JsonConfig.Default);
      return result ?? new List<DuplicateResponseDto>();
    }
    catch (OperationCanceledException) when (cancellationToken.IsCancellationRequested)
    {
  ...
  /// </summary>
  public async Task<List<BulkIdResponseDto>> ResolveDuplicatesAsync(Apigen.Immich.Models.DuplicateResolveDto duplicateResolveDto, CancellationToken cancellationToken = default)
  {
  ...
  public async Task DeleteAsync(string id, CancellationToken cancellationToken = default)
  {
    ...
    string url = "duplicates/{id}".BuildUrl(pathParams);
