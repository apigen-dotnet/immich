...
public partial class WorkflowsClient
{
  ...
  /// </summary>
  public async Task<List<WorkflowResponseDto>> GetWorkflowsAsync(CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<WorkflowResponseDto> CreateAsync(Apigen.Immich.Models.WorkflowCreateDto workflowCreateDto, CancellationToken cancellationToken = default)
  {
    string url = "workflows";
  ...
  /// </summary>
  public async Task<WorkflowResponseDto> GetAsync(string id, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<WorkflowResponseDto> UpdateAsync(string id, Apigen.Immich.Models.WorkflowUpdateDto workflowUpdateDto, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
